...
export const navItems = [
  {
    label: 'Employees',
    path: '/employees',
    allowedRoles: null, // EMP_VIEW → all roles
    icon: (
  ...
  },
  {
    label: 'Job History',
    path: '/jobhistory',
    allowedRoles: null, // JH_VIEW → all roles
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
  ...
  },
  {
    label: 'Jobs',
    path: '/jobs',
    allowedRoles: null, // JOB_VIEW → all roles; write actions gated inside the page
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
  ...
  },
  {
    label: 'Departments',
    path: '/departments',
    allowedRoles: null, // DEPT_VIEW → all roles; write actions gated inside the page
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
  ...
  },
  {
    label: 'Admin',
    path: '/admin',
    allowedRoles: ['SUPERADMIN'], // ADM_USER right → SUPERADMIN only per rights matrix
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
  ...
  },
  {
    label: 'Deleted Items',
    path: '/deleted-items',
    allowedRoles: ['ADMIN', 'SUPERADMIN'], // INACTIVE records → ADMIN + SUPERADMIN only
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
